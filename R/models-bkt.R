...
#' @export
bkt <- function(parallel = TRUE, num_fits = 5, folds = 5, seed = sample(1:1e8, 1), model_type = rep(FALSE, 4), ...) {
  new("Model", parallel = parallel, num_fits = num_fits, folds = folds, seed = seed, model_type = model_type, ...)
}
